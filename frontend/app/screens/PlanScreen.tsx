...
const PlanScreen: React.FC = () => {
  ...
  const createPlanMutation = useMutation({
    ...
    onSuccess: () => {
      Alert.alert(
        'Success!',
        'Your Day Plan is created. Find it in My Day Plans.',
        [
  ...
  const handleGetRecommendations = () => {
    if (!formData.places[0] || !formData.goingWith || !formData.focus) {
          ...
          <View style={styles.optionsContainer}>
            {['friends', 'family', 'partner', 'business', 'solo'].map((option) => (
              <TouchableOpacity
                ...
                onPress={() => setFormData({ ...formData, goingWith: option })}
              >
                <Text
                  style={[
                    styles.optionText,
        ...
        <View style={styles.optionsContainer}>
          {['food', 'attractions', 'both'].map((option) => (
            <TouchableOpacity
              ...
              onPress={() => setFormData({ ...formData, focus: option })}
            >
              <Text
                style={[
                  styles.optionText,
  ...
  const BuildYourDaySection = () => {
    ...
    return (
      <View style={styles.resultsSection}>
        <Text style={styles.resultsTitle}>Build Your Day</Text>
            ...
            {food_places.map((place: any, index: number) => (
              ...
              >
                ...
                <Text style={styles.placeDetails}>
                  Top dishes: {place.top_dishes?.join(', ')}
                </Text>
        ...
        {(formData.focus === 'attractions' || formData.focus === 'both') && (
          <View style={styles.categorySection}>
            <Text style={styles.categoryTitle}>Places to Visit</Text>
